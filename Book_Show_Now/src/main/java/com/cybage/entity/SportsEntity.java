...
public class SportsEntity {
	...
	public SportsEntity(int sportsId, String sportsName, String date, String location, double price,
	...
	public String toString() {
		return "SportsEntity [sportsId=" + sportsId + ", sportsName=" + sportsName + ", date=" + date + ", location="
